import ComparePlanTable from "@/components/features/pricing/tables/compare-plan";
    ...
    <>
      ...
      <div className="container mx-auto px-4 md:px-6 2xl:max-w-[1400px] py-24 lg:py-32">
        ...
        <div className="flex justify-center items-center">
          ...
          <Switch id="payment-schedule" className="bg-secondary" />
          <Label htmlFor="payment-schedule" className="relative ms-3">
            Annual
            <span className="absolute -top-10 start-auto -end-28 animate-bounce">
              <span className="flex items-center">
                ...
                <Badge className="mt-3 uppercase text-white">
                  Save up to 10%
                </Badge>
              </span>
            </span>
        ...
        <div className="mt-12 grid sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:items-center">
          ...
          {/* End Card */}
          {/* Card */}
          <Card className="flex flex-col relative border-primary/50">
            <CardHeader className="text-center pb-2">
              <Badge className="uppercase w-max self-center mb-3 text-white">
                Most popular
              </Badge>
              <CardTitle className="!mb-7">Startup</CardTitle>
              <span className="font-bold text-5xl">RM39</span>
            </CardHeader>
            ...
            <CardFooter>
              <Button className="w-full font-bold text-white">Sign up</Button>
            </CardFooter>
      ...
      <div className="bg-secondary py-8 ">
        <div className="my-20 max-container mx-4 md:mx-auto space-y-4">
          <h2 className="text-4xl md:text-5xl font-bold">
            Join the next wave of entrepreneurs
          </h2>
      ...
      <div className="max-container mx-4 lg:mx-auto">
        <ComparePlanTable />
      </div>
      ...
      <div className="max-container flex-row-center my-20">
        <Card className="w-full max-w-md">
          ...
          <CardFooter className="flex-row gap-2">
            ...
            <Button variant="default" className="w-full font-bold text-white">
              Talk to Sales
            </Button>
          </CardFooter>
        </Card>
